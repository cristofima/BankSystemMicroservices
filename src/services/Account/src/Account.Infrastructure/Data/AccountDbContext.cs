...
public class AccountDbContext(DbContextOptions<AccountDbContext> options) : DbContext(options)
{
    ...
    private static void ConfigureAccount(ModelBuilder modelBuilder)
    {
        ...
        accountEntity.Property(a => a.AccountNumber)
            .IsRequired()
            .HasMaxLength(10)
            .IsFixedLength()
            .HasConversion(
        ...
        accountEntity.Property(a => a.Type)
            .IsRequired()
            .HasConversion<string>()
            .HasMaxLength(15);

        accountEntity.Property(a => a.Status)
            .IsRequired()
            .HasConversion<string>()
            .HasMaxLength(20);

        // Configure Money value object for Balance
        accountEntity.OwnsOne(a => a.Balance, balanceBuilder =>
        {
            ...
            balanceBuilder.OwnsOne(m => m.Currency, currencyBuilder =>
            {
        ...
        accountEntity.Property(a => a.UpdatedAt)
            .IsRequired(false);

        accountEntity.Property(a => a.CreatedBy)
            .HasMaxLength(30);

        accountEntity.Property(a => a.UpdatedBy)
            .HasMaxLength(30);

        // Indexes for performance
        accountEntity.HasIndex(a => a.AccountNumber)
            .IsUnique()
            .HasDatabaseName("IX_Accounts_AccountNumber");

        accountEntity.HasIndex(a => a.CustomerId)
            .HasDatabaseName("IX_Accounts_CustomerId");

        accountEntity.HasIndex(a => a.Status)
            .HasDatabaseName("IX_Accounts_Status");

        accountEntity.HasIndex(a => a.CreatedAt)
    ...
    public override async Task<int> SaveChangesAsync(CancellationToken cancellationToken = default)
    {
        ...
        var entries = ChangeTracker.Entries()
            .Where(e => e is { Entity: AuditedEntity, State: EntityState.Added or EntityState.Modified });
